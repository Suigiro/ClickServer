 ...
 */
class GetCPC extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('ClickServer_CPC');
        $this->dimension     = null;
        $this->documentation = Piwik::translate('Campanhas CPC');
        ...
        $this->metrics = array('oferta', 'campanha', 'clicks', 'CPC', 'CTR(%aberturas)', 'aberturas', 'conversao', 'disparado em');
        ...
        // exported as a widget
             $this->widgetTitle  = 'ClickServer_CPC';
    }
