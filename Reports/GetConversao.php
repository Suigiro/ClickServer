 ...
 */
class GetConversao extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('ClickServer_Conversao');
        $this->dimension     = null;
        $this->documentation = Piwik::translate('Campanhas Conversão');
        ...
        $this->metrics = array('campanha', 'url', 'dispositivo', 'navegador', 'localização', 'criado em');
        ...
        // exported as a widget
             $this->widgetTitle  = 'ClickServer_Conversão';
    }
