 ...
 */
class GetCPL extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('ClickServer_CPL');
        $this->dimension     = null;
        $this->documentation = Piwik::translate('Campanhas CPL');
        ...
        $this->metrics = array('oferta', 'camapanhas', 'clicks', 'CPL', 'aberturas','disparado em');
        ...
        // exported as a widget
             $this->widgetTitle  = 'ClickServer_CPL';
    }
