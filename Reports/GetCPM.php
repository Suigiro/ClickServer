 ...
 */
class GetCPM extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('ClickServer_CPM');
        $this->dimension     = null;
        $this->documentation = Piwik::translate('Campanhas CPM');
        ...
        $this->metrics = array('oferta', 'campanha', 'clicks', 'envios', 'CPM', 'OTR(%aberturas)', 'aberturas', 'conversao', 'disparado em');
        ...
        // exported as a widget
             $this->widgetTitle  = 'ClickServer_CPM';
    }
